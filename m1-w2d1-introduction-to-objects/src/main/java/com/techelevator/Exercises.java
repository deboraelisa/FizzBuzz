...
public class Exercises {
	...
	public String extraEnd(String str) {
		String threeCopies = str.substring(str.length() - 2, str.length());
	...
	public String firstHalf(String str) {
		int lengthOfNewString = str.length() / 2;
		String half = str.substring(0, lengthOfNewString);
		return half;
	}
	...
	public String nonStart(String a, String b) {
		String aNoFirst = a.substring(1);
		String bNoFirst = b.substring(1);
		return aNoFirst + bNoFirst;
	}
	// or
	// String result = aNoFirst + bNoFirst;
	// return result;
	// or
	...
	public String left2(String str) {
		...
		String lessFirstTwo = str.substring(2, str.length());
		return lessFirstTwo + firstTwoChars;
	}
	...
	public String right2(String str) {
		...
		String lesslastTwo = str.substring(0, str.length() - 2);
		return lastTwoChars + lesslastTwo;
	}
	...
	public String theEnd(String str, boolean front) {
		if (front) {
			String length1 = str.substring(0, 1);
			return length1;
		} else {
			String length1 = str.substring(str.length() - 1, str.length());
			return length1;
		}
	}
	...
	public String middleTwo(String str) {
		if (str.length() == 2) {
			...
			String firstHalfLastChar = str.substring(halfLength - 1, halfLength + 1);

			return firstHalfLastChar;
		}
	}
	...
	public boolean endsLy(String str) {
		 ...
		 * if(str.charAt(str.length() -1) == 'y' && str.charAt(str.length() -2)
		 * == 'l') { //char has to be written with '' single quotes return true;
		 * } else { return false;
		 */
	...
	public String nTwice(String str, int n) {
		String nFirstChar = str.substring(0, n);
		String nLastChar = str.substring(str.length() - n, str.length());
		return nFirstChar + nLastChar;
	}
	...
	public String middleThree(String str) {
		...
		String middleThree = str.substring(middleOfString - 1, middleOfString + 2);
		return middleThree;
	}
	...
	public String frontTimes(String str, int n) {
		String nCopies = new String();
		String helper = new String();
		if (str.length() <= 3) {
			helper = str;
		} else {
			helper = str.substring(0, 3);
		}
		for (int i = 0; i < n; i++) {
			nCopies += helper;
		}
	...
	public int countXX(String str) {
		...
		if (firstX == -1) {
			...
			for (; firstX < str.length() - 1; firstX++) {
				if (str.charAt(firstX) == 'x' && str.charAt(firstX + 1) == 'x') {
					counter += 1;
				}
			}
		}
	...
	public int last2(String str) {
		...
		String lastTwo = new String();
		lastTwo = str.substring(str.length() - 2);
		for (int i = 0; i < str.length(); i++) {
			if (str.indexOf(lastTwo, i) == i) { // counting the match to LastTwo
												// only if it is where the i
												// variable is while going
												// through loop
				counter += 1;
			}
		}
